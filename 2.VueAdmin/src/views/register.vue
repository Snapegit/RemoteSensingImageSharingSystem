	...
	<div>
		<div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20230908/322b929098b24499a774ded5b49b487b.jpg)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center","height":"auto"}'>
			<el-form v-if="pageFlag=='register'" :style='{"border":"1px solid #ccc","padding":"30px 0px 20px 30px","boxShadow":"0 0px 0px rgba(0, 0, 0, .2)","margin":"100px auto","borderRadius":"4px","textAlign":"center","background":"rgba(255,255,255,.96)","width":"30vw","fontSize":"16px","position":"relative","height":"auto"}' ref="rgsForm" class="rgs-form" :model="rgsForm" :rules="rules">
				<div v-if="true" :style='{"padding":"0px","margin":"10px auto 0px","borderColor":"#eee","color":"#fff","display":"inline-block","top":"-80px","left":"-100%","background":"none","borderWidth":"0px","width":"300%","lineHeight":"40px","fontSize":"32px","position":"absolute","borderStyle":"solid","fontWeight":"600"}' class="title">Java-基于SpringBoot的遥感影像共享系统注册</div>
				...
				<el-form-item :style='{"padding":"0 0px","margin":"0 auto 10px","textAlign":"left","width":"calc(100% - 150px)","fontSize":"inherit","position":"relative","height":"auto"}' class="list-item" v-if="tableName=='yonghu'">
					<div v-if="true" :style='{"padding":"0 8px 0 0","color":"#666","textAlign":"right","left":"-150px","width":"150px","lineHeight":"40px","fontSize":"14px","position":"absolute"}' class="lable" :class="changeRules('yonghushouji')?'required':''">用户手机：</div>
					<el-input  v-model="ruleForm.yonghushouji"  autocomplete="off" placeholder="用户手机"  type="text"  />
				</el-form-item>
				<el-form-item :style='{"padding":"0 0px","margin":"0 auto 10px","textAlign":"left","width":"calc(100% - 150px)","fontSize":"inherit","position":"relative","height":"auto"}' class="list-item" v-if="tableName=='bumenguanliyuan'">
					<div v-if="true" :style='{"padding":"0 8px 0 0","color":"#666","textAlign":"right","left":"-150px","width":"150px","lineHeight":"40px","fontSize":"14px","position":"absolute"}' class="lable" :class="changeRules('bumenzhanghao')?'required':''">部门账号：</div>
				...
				<el-form-item :style='{"padding":"0 0px","margin":"0 auto 10px","textAlign":"left","width":"calc(100% - 150px)","fontSize":"inherit","position":"relative","height":"auto"}' class="list-item" v-if="tableName=='bumenguanliyuan'">
					<div v-if="true" :style='{"padding":"0 8px 0 0","color":"#666","textAlign":"right","left":"-150px","width":"150px","lineHeight":"40px","fontSize":"14px","position":"absolute"}' class="lable" :class="changeRules('guanliyuanxingming')?'required':''">管理员姓名：</div>
					<el-input  v-model="ruleForm.guanliyuanxingming"  autocomplete="off" placeholder="管理员姓名"  type="text"  />
				</el-form-item>
				<el-form-item :style='{"padding":"0 0px","margin":"0 auto 10px","textAlign":"left","width":"calc(100% - 150px)","fontSize":"inherit","position":"relative","height":"auto"}' class="list-item" v-if="tableName=='bumenguanliyuan'">
					<div v-if="true" :style='{"padding":"0 8px 0 0","color":"#666","textAlign":"right","left":"-150px","width":"150px","lineHeight":"40px","fontSize":"14px","position":"absolute"}' class="lable" :class="changeRules('touxiang')?'required':''">头像：</div>
                    <file-upload
				...
				<el-form-item :style='{"padding":"0 0px","margin":"0 auto 10px","textAlign":"left","width":"calc(100% - 150px)","fontSize":"inherit","position":"relative","height":"auto"}' class="list-item" v-if="tableName=='bumenguanliyuan'">
					<div v-if="true" :style='{"padding":"0 8px 0 0","color":"#666","textAlign":"right","left":"-150px","width":"150px","lineHeight":"40px","fontSize":"14px","position":"absolute"}' class="lable" :class="changeRules('bumen')?'required':''">部门：</div>
				...
				<el-form-item :style='{"padding":"0 0px","margin":"0 auto 10px","textAlign":"left","width":"calc(100% - 150px)","fontSize":"inherit","position":"relative","height":"auto"}' class="list-item" v-if="tableName=='bumenguanliyuan'">
					<div v-if="true" :style='{"padding":"0 8px 0 0","color":"#666","textAlign":"right","left":"-150px","width":"150px","lineHeight":"40px","fontSize":"14px","position":"absolute"}' class="lable" :class="changeRules('dianhua')?'required':''">电话：</div>
...
export default {
	...
	mounted(){
		...
		if(this.$route.query.pageFlag=='register'){
			...
			if(this.tableName=='bumenguanliyuan'){
				this.ruleForm = {
					bumenzhanghao: '',
					mima: '',
					guanliyuanxingming: '',
			...
			if ('bumenguanliyuan' == this.tableName) {
				this.rules.bumenzhanghao = [{ required: true, message: '请输入部门账号', trigger: 'blur' }]
			}
			if ('bumenguanliyuan' == this.tableName) {
				this.rules.mima = [{ required: true, message: '请输入密码', trigger: 'blur' }]
			}
		...
		login() {
            ...
            if(this.ruleForm.touxiang!=null) {
                this.ruleForm.touxiang = this.ruleForm.touxiang.replace(new RegExp(this.$base.url,"g"),"");
					...
					if((!this.ruleForm.bumenzhanghao) && `bumenguanliyuan` == this.tableName){
            ...
            if(this.ruleForm.touxiang!=null) {
                this.ruleForm.touxiang = this.ruleForm.touxiang.replace(new RegExp(this.$base.url,"g"),"");
					...
					if(`bumenguanliyuan` == this.tableName && this.ruleForm.nianling &&(!this.$validate.isIntNumer(this.ruleForm.nianling))){
